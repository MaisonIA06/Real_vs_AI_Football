...
QUESTIONS = [
    {
        ...
        'correct_index': 0,
        'anecdote': "Après le match, Diego Maradona expliqua que son but avait été marqué « un peu avec la tête de Maradona et un peu avec la main de Dieu ».",
    },
    {
        'order': 2,
        'image': 'Qu2.jpg',
    ...
    },
    {
        ...
        'choices': ["Sur son oreillette", "Sur sa montre", "Sur l'écran géant", "Sur le téléphone de Charles Ange Ginésy 😄"],
        'correct_index': 1,
